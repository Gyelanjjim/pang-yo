  ...
  return (
    <div className="flex max-w-5xl px-4 pt-5 mx-auto">
      ...
      <div className="hidden w-4/12 ml-3 md:block">
        ...
        <div className="p-2 bg-white rounded-b mb-4">
          <p>{dayjs(data.user.createdAt).format("YYYY.MM.DD")} 가입</p>
          <p> 신분: 제빵 수험생 </p>
          <p>주의! 수험생은 빵 판매수익을 얻을 수 없습니다</p>
        </div>
        <div className="flex items-center p-3 bg-gray-400 rounded-t">
          <p> 제빵자격증 취득 요건</p>
        </div>
        <div className="p-2 bg-white rounded-b">
          <p>1. 가이드 라인 읽기</p>
          <p>2. 신분 증명하기: 이메일 인증</p>
          <p>3. 수험표 발급받기: 사진 등록</p>
          <p>4. 제빵 실기시험: 게시글 작성</p>
          <p>5. 평가 및 결과 조회: 다른 게시글 평가</p>
        </div>
      </div>
    </div>
  );
